...
def plot_sources_distribution(source_locations, width, size=10):
...
def plot_ins_distribution(source_locations, width, bins=360, size=(6, 12)):
    ...
    theta_center = np.linspace(st, st+2*np.pi, 8)
